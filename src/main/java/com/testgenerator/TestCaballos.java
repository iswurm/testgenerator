...
public class TestCaballos {
    ...
    public void ejecutar() {
        try (Playwright playwright = Playwright.create()) {
            ...
            page.getByRole(AriaRole.ROW, new Page.GetByRoleOptions().setName("[DEPRECADO] RC + Vida 39,18 €"))
                    .locator("label").click();
            page.waitForTimeout(300);
            page.getByRole(AriaRole.BUTTON, new Page.GetByRoleOptions().setName("Continuar")).click();
            ...
            page.getByRole(AriaRole.COMBOBOX, new Page.GetByRoleOptions().setName("Tipo de vía")).selectOption("BRNCO");
