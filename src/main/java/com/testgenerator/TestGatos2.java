...
public class TestGatos2 {
    ...
    String[] arrayEdadesGato = new String[4];
    String[] sexoTomador = new String[2];
    String[] estadoCivil = new String[6];
    String[] sexoAnimal = new String[2];
    ...
    public String ejecutar(){
        arrayEdadesGato[0] = "1: T010";
        arrayEdadesGato[1] = "2: T020";
        arrayEdadesGato[2] = "3: T030";
        arrayEdadesGato[3] = "4: T040";
        sexoTomador[0] = "1: H";
        sexoTomador[1] = "2: M";
        estadoCivil[0] = "1: CA";
        estadoCivil[1] = "2: OT";
        ...
        try (Playwright playwright = Playwright.create()) {
            ...
            page.getByRole(AriaRole.COMBOBOX, new Page.GetByRoleOptions().setName("Sexo")).selectOption(sexoTomador[random.nextInt((1 - 0) + 1)]);
